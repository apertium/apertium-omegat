...
public class ManageDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        displayMarksCheckBox.setSelected(ApertiumTranslate.prefs.getBoolean("OmegaT_displayMarks", true));
        displayMarksCheckBox.setText("Mark unknown words");

        displayAmbiguityCheckBox.setSelected(ApertiumTranslate.prefs.getBoolean("OmegaT_displayAmbiguity", false));
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        ApertiumTranslate.prefs.putBoolean("OmegaT_displayMarks", displayMarksCheckBox.isSelected());
        ApertiumTranslate.prefs.putBoolean("OmegaT_displayAmbiguity", displayAmbiguityCheckBox.isSelected());
        this.dispose();
